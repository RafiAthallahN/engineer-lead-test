        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid space-y-2">
                @if (Auth::user() && Auth::user()->isAdmin())
                    ...
                    <flux:navlist.item icon="home" :href="route('booking.create')"
                        :current="request()->routeIs('booking.create')" wire:navigate>{{ __('Booking') }}
                    </flux:navlist.item>

                @else
                    <flux:navlist.item icon="home" :href="route('approval.index')"
                        :current="request()->routeIs('approval.index')" wire:navigate>{{ __('Approval') }}
                    </flux:navlist.item>
                @endif
